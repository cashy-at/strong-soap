...
describe("SOAP Server", function () {
  before(function (done) {
    fs.readFile(
      __dirname + "/wsdl/strict/stockquote.wsdl",
      "utf8",
      function (err, data) {
        assert.ok(!err);
        test.wsdl = data;
  ...
  it("should return predefined headers in response", function (done) {
    soap.createClient(
      ...
      function (err, client) {
        ...
        client.GetLastTradePrice(
          { TradePriceRequest: { tickerSymbol: "AAPL" } },
          function (err, result, raw, headers) {
            assert.ok(!err);
  ...
  it("should return complete client description", function (done) {
    soap.createClient(
      ...
      function (err, client) {
        ...
        assert.equal(
          description.StockQuoteService.StockQuotePort.GetLastTradePrice.input
            .body.elements[0].qname.name,
          "TradePriceRequest"
        );
        assert.equal(
          description.StockQuoteService.StockQuotePort.GetLastTradePrice.input
            .body.elements[0].elements[0].qname.name,
          "tickerSymbol"
        );
        assert.equal(
          description.StockQuoteService.StockQuotePort.GetLastTradePrice.input
            .body.elements[0].elements[0].type.name,
          "string"
        );
        done();
      }
  ...
  it("should return correct async results (single argument callback style)", function (done) {
    soap.createClient(
      ...
      function (err, client) {
        assert.ok(!err);
        client.GetLastTradePrice(
          { TradePriceRequest: { tickerSymbol: "Async" } },
  ...
  it("should return correct async errors", function (done) {
    soap.createClient(
      ...
      function (err, client) {
        assert.ok(!err);
        client.IsValidPrice(
          { TradePrice: { price: "invalid_price" } },
          function (err, result) {
            assert.ok(err);
  ...
  it("should include response and body in error object", function (done) {
    soap.createClient(
      ...
      function (err, client) {
        assert.ok(!err);
        client.GetLastTradePrice(
          { TradePriceRequest: { tickerSymbol: "trigger error" } },
  ...
  it("should return SOAP Fault body for SOAP 1.2", function (done) {
    soap.createClient(
      ...
      function (err, client) {
        ...
        client.GetLastTradePrice(
          { TradePriceRequest: { tickerSymbol: "SOAP Fault v1.2" } },
          function (err, response, body) {
            assert.ok(err);
  ...
  it("should return SOAP Fault body for SOAP 1.1", function (done) {
    soap.createClient(
      ...
      function (err, client) {
        assert.ok(!err);
        client.GetLastTradePrice(
          { TradePriceRequest: { tickerSymbol: "SOAP Fault v1.1" } },
          function (err, response, body) {
            assert.ok(err);
            var fault = err.root.Envelope.Body.Fault;
            assert.equal(
  ...
  it("should handle one-way operations", function (done) {
    soap.createClient(
      ...
      function (err, client) {
        assert.ok(!err);
        client.SetTradePrice(
          { TradePriceSubmit: { tickerSymbol: "GOOG", price: 575.33 } },
          function (err, result) {
            assert.ok(!err);
